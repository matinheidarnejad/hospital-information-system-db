...
BEGIN
    ...
    BEGIN
        RAISERROR('At least one of the physician or the department must be specified.', 16, 1);
        RETURN;
    END;
    ...
    BEGIN
        RAISERROR('The patient already has another active appointment at this exact time.', 16, 1);
        RETURN;
    END;
    ...
    SELECT @AppointmentID AS AppointmentID, 'The appointment has been successfully booked.' AS Message;
END;
GO
